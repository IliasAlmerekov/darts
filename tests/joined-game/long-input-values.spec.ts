...
test.describe("Error Handling and Edge Cases", () => {
  test("Long Input Values", async ({ page }) => {
    ...
    // Should either accept the values or provide validation feedback
    await expect(page).toHaveURL("http://localhost:5173/"); // Should stay on login page or redirect appropriately
